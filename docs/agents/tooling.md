...
Everything on this page is optional. None of it is needed to build, test, or contribute to Threadbase Landing Page — it is the AI-assistant tooling this repo expects, declared in config so your agent can pick it up instead of you wiring it by hand.
...
| `ui-design` | `claude-code-workflows` | Design-system and accessibility skills |
